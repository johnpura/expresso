...
/*
    @route          GET /api/menus/:menuId/menu-items
    @description    Gets all menu items on a menu
*/
...
/*
    @route          POST /api/menus/:menuId/menu-items
...
/*
    @route          PUT /api/menus/:menuId/menu-items/:menuItemId
...
/*
    @route          DELETE /api/menus/:menuId/menu-items/:menuItemId
